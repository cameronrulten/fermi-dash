...
days: Optional[Tuple[str,...]] = typer.Option(None, help="Lightcurve bin sizes to include. Accepts multiple values: --days 7 30 365 or comma-separated: --days 7,30,365", nargs=-1),
